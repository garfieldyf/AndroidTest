...
public class GIFImage {
    ...
    public boolean draw(Bitmap bitmapCanvas, int frameIndex) {
        DebugUtils._checkError(!bitmapCanvas.isMutable(), "Immutable bitmap passed to GIFImage draw");
        DebugUtils._checkError(bitmapCanvas.getConfig() != Config.ARGB_8888, "The bitmap canvas pixel format must be ARGB_8888");
