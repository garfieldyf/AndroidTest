...
import android.ext.temp.DynamicClassLoader;
import android.ext.temp.JsonLoader;
import android.ext.temp.JsonLoader.AppLoadParams;
import android.ext.temp.JsonLoader.JsonLoadParams;
import android.ext.util.ArrayUtils;
import android.ext.util.ByteArrayBuffer;
import android.ext.util.CountDownTimer;
...
import com.tencent.test.ui.WebViewActivity;
...
//        printer.println("isDirectory = " + new File(path).isDirectory());
    ...
    private void testJsonLoader() {
        ...
        final JsonLoadParams params = new JsonLoadParams();
//        final URLLoadParams params = new URLLoadParams();
        ...
        loader.load(url3, new AppLoadParams(), JsonLoader.sListener, null);
