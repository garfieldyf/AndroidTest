...
//        JSONUtils.EMPTY_OBJECT.put("aaa", 2);
    ...
    private void testComputeFileSizes() {
        ...
        for (int i = 0; i < size; ++i) {
            DebugUtils.startMethodTracing();
            long l = FileUtils.computeFileSize(dir.getPath());
...
//        Log.i("yf", "w = " + drawable.getIntrinsicWidth() + ", h = " + drawable.getIntrinsicHeight());
    ...
    private static final class SQLiteHandler extends AsyncSQLiteHandler {
        ...
        protected Object onExecute(SQLiteDatabase db, int token, String table, String arg1, String arg2, Object[] params) {
            Log.d("abcd", "token = " + token + ", table = " + table + ", arg1 = " + arg1 + ", arg2 = " + arg2 + ", params = " + Arrays.toString(params));
            return params[0];
        }
    ...
    private void testDBHandler() {
        ...
        handler.startExecute(1, "note", "a", "2", (Object[])null);
