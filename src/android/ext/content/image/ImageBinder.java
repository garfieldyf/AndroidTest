...
public class ImageBinder<URI, Image> implements Binder<URI, Object, Image> {
    ...
    public ImageBinder(Context context, AttributeSet attrs) {
        ...
        final int maxSize  = a.getInt(0 /* R.styleable.ImageBinder_maxCacheSize */, 0);
        mDefaultImage = a.getDrawable(1 /* R.styleable.ImageBinder_defaultImage */);
        a.recycle();
     ...
     * <tr><td><tt>maxCacheSize</tt></td><td>integer</td><td>0</td></tr>
     * <tr><td><tt>defaultImage</tt></td><td>reference</td><td>1</td></tr>
     * </table></p>
