...
public abstract class ImageDrawable<T extends ImageDrawable.ImageState> extends Drawable {
    ...
    public void inflate(Resources res, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
        ...
        mState.mFlags |= (IMAGE_DRAWABLE_ATTRS[MIRROR_INDEX] == android.R.attr.autoMirrored ? (a.getBoolean(MIRROR_INDEX /* android.R.attr.autoMirrored */, false) ? HORIZONTAL_MIRRORED : NONE_MIRRORED) : a.getInt(MIRROR_INDEX /* R.attr.autoMirrored */, NONE_MIRRORED));
        a.recycle();
    ...
    public static void initAttrs(int autoMirroredAttr) {
        IMAGE_DRAWABLE_ATTRS[MIRROR_INDEX] = autoMirroredAttr;
    }
     ...
     * <em>outBounds</em> may not equals to this drawable's bounds. By default,
     * this returns bounds computed with this drawable's gravity and bounds.
