...
ifeq ($(all),1)
LOCAL_CPPFLAGS += -D__BUILD_ERRORS__ -D__BUILD_GIFIMAGE__ -D__BUILD_FILEUTILS__ -D__BUILD_PROCUTILS__ -D__BUILD_BITMAPUTILS__ -D__BUILD_MESSAGEDIGESTS__
LOCAL_LDLIBS   += -landroid -ljnigraphics
LOCAL_STATIC_LIBRARIES += $(LOCAL_MD_MODULE) $(LOCAL_GIF_MODULE) $(LOCAL_IMGALGTH_MODULE)
else
ifeq ($(errors),1)
LOCAL_CPPFLAGS += -D__BUILD_ERRORS__
endif
