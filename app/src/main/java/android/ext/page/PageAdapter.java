...
public abstract class PageAdapter<E, VH extends ViewHolder> extends BaseAdapter<VH> {
     ...
     */
    public final void setPage(int pageIndex, Page<E> page) {
     ...
     * @param pageIndex The index of the page.
     * @param page May be <tt>null</tt>. The {@link List} of the page data to add.
...
//    }
    ...
    public final void dump(Printer printer) {
        ...
        if (mPageCache instanceof ArrayMapCache) {
            dump(printer, ((ArrayMapCache<Integer, Page<E>>)mPageCache).entrySet());
        } else if (mPageCache instanceof SimpleLruCache) {
            dump(printer, ((SimpleLruCache<Integer, Page<E>>)mPageCache).snapshot().entrySet());
        }
    }
     ...
     * this method to return <tt>Page</tt> for a particular page. <p>If you want to
