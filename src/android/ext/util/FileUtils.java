...
public final class FileUtils {
    ...
    public static class Dirent implements Parcelable, Cloneable, Comparable<Dirent> {
        ...
        public Dirent(String path) {
            DebugUtils._checkError(path == null, "path == null");
            setPath(path);
        }
        ...
        public Dirent(String dir, String name, int type) {
            DebugUtils._checkError(dir == null || name == null, "dirPath == null || name == null");
         ...
         */
        public long length() {
            DebugUtils._checkError(!isAbsolute(), "The path must be absolute file path.");
        ...
        private static void _checkDirentType(Dirent dirent) {
            final int type;
    ...
    public static class Properties extends java.util.Properties {
        ...
        public final boolean load() {
            DebugUtils._checkError(mPath == null, "path == null, Must be invoke 'new Properties(filename)' constructor.");
            return load(mPath);
        }
