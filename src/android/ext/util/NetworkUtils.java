...
public final class NetworkUtils {
    ...
    public static final class DownloadRequest {
        ...
        public final DownloadRequest post(Object data) {
            DebugUtils._checkWarning(this.data != null, "DownloadRequest", "The post data is already exists. Do you want overrides it.");
            this.data = data;
            return this;
        }
        ...
        public final <Params, T extends AsyncTask<Params, ?, ?>> T execute(Params... params) {
            DebugUtils._checkError(task == null, "The DownloadRequest must be call AsyncDownloadTask.newDownloadRequest() to create");
        ...
        /* package */ final int connect(byte[] tempBuffer) throws IOException {
            DownloadRequest._checkHeaders(connection, true);
            ...
            DownloadRequest._checkHeaders(connection, false);
        ...
        private static void _checkHeaders(URLConnection conn, boolean request) {
    ...
    public static class AsyncDownloadTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> implements Cancelable {
        ...
        public final DownloadRequest newDownloadRequest(String url) {
            try {
                DebugUtils._checkError(mRequest != null, "The DownloadRequest is already exists. Only one DownloadRequest may be created per " + getClass().getName());
        ...
        protected Result doInBackground(Params... params) {
            DebugUtils._checkError(mRequest == null, "The " + getClass().getName() + " did not call newDownloadRequest()");
            Result result = null;
            try {
