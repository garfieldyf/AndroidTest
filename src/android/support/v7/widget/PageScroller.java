...
public class PageScroller {
    ...
    /**
     * Initialize the {@link PageScroller} styleable. <p>Note: This method recommended call in the
     ...
     * <tr><td><tt>pageSize</tt></td><td>dimension</td><td>0</td></tr>
     * </table></p>
     * @param attrs The <tt>R.styleable.PageScroller</tt> styleable, as generated by the aapt tool.
     */
    public static void initAttrs(int[] attrs) {
        DebugUtils.__checkError(PAGE_SCROLLER_ATTRS != null, "The attributes has already initialized.");
        PAGE_SCROLLER_ATTRS = attrs;
    }
