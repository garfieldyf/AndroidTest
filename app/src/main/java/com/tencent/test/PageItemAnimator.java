...
public class PageItemAnimator extends SimpleItemAnimator {
...
//        oldHolder.itemView.setTranslationY(prevTranslationY);
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (oldView != null) {
//            final ViewPropertyAnimator oldViewAnimation = oldView.animate().setDuration(
//                    getChangeDuration());
//            mChangeAnimations.add(changeInfo.oldHolder);
//            oldViewAnimation.translationX(changeInfo.toX - changeInfo.fromX);
//            oldViewAnimation.translationY(changeInfo.toY - changeInfo.fromY);
//            oldViewAnimation.setListener(new AnimatorListenerAdapter() {
//                @Override
//                public void onAnimationStart(Animator animator) {
